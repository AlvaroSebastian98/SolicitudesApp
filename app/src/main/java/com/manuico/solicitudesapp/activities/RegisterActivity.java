...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipoInput = findViewById(R.id.tipo_solicitud_input);
    ...
    public void callRegister(View view) {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createSolicitud(id, correo, tipo, motivo);
        } else {
            ...
            RequestBody idUsuario = RequestBody.create(MultipartBody.FORM, ""+id);
            ...
            call = service.createSolicitudWithImage(idUsuario, nombrePart, precioPart, detallesPart, imagenPart);
        }
